    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('0', 'Regular'), ('1', 'Abandonó'), ('2', 'Finalizado')], max_length=1, verbose_name='estado')),
                ('rut_apoderado', models.ForeignKey(max_length=13, on_delete=django.db.models.deletion.CASCADE, related_name='alumnos', to='alumnos.apoderado')),
            ],
            options={
                'verbose_name': 'Alumno',
